...
import { Search, Eye, MessageCircle, Loader2 } from 'lucide-react'
...
export function OrdersTable({ pedidos }: OrdersTableProps) {
  ...
  const handleStatusChange = async (pedidoId: string, newStatus: EstadoPedido) => {
...
Tu pedido *${pedido.codigo}* de CoffeJuancho:

${itemsList}

*Total: ${formatPrice(pedido.total)}*

Estado: ${ESTADOS_PEDIDO[pedido.estado].label}
${pedido.tipo_entrega === 'domicilio' ? `Direccion: ${pedido.direccion}` : 'Recoger en tienda'}
              ...
              <table className="w-full">
                <thead>
                  <tr className="border-b bg-muted/50">
                    ...
                    <th className="text-left py-3 px-4 text-sm font-medium">Telefono</th>
                ...
                <tbody>
                  {filteredPedidos.map((pedido) => (
                    <tr key={pedido.id} className="border-b last:border-0 hover:bg-muted/30">
                      ...
                      <td className="py-3 px-4">{pedido.nombre_cliente}</td>
                      <td className="py-3 px-4">{pedido.telefono}</td>
              ...
              <div className="grid grid-cols-2 gap-4 text-sm">
                ...
                <div>
                  ...
                  <p className="font-medium">
                    {selectedOrder.tipo_entrega === 'domicilio' ? 'Domicilio' : 'Recoger'}
                  </p>
                </div>
